...
var decodeCodePoint = require("entities/lib/decode_codepoint.js"),
    ...
    BEFORE_COMMENT                     = i++,
    IN_COMMENT                         = i++,
    IN_COMMENT_OR_CONDITIONAL_COMMENT  = i++,
    IN_OPEN_CONDITIONAL_COMMENT        = i++,
    IN_CLOSE_CONDITIONAL_COMMENT_1     = i++,
    IN_CLOSE_CONDITIONAL_COMMENT_2     = i++,
    AFTER_COMMENT_1                    = i++,
    AFTER_COMMENT_2                    = i++,
...
Tokenizer.prototype._stateInDeclaration = function(c){
	if(c === ">"){
		...
		this._state = IN_CLOSE_CONDITIONAL_COMMENT_1;
	}
};

Tokenizer.prototype._stateinCloseConditionalComment1 = function(c){
	if(c === "-"){
		this._state = IN_CLOSE_CONDITIONAL_COMMENT_2;
	} else {
...
Tokenizer.prototype._stateBeforeComment = function(c){
	if(c === "-"){
		this._state = IN_COMMENT_OR_CONDITIONAL_COMMENT;
		this._sectionStart = this._index + 1;
	} else {
		this._state = IN_DECLARATION;
	}
...
Tokenizer.prototype._stateInCommentOrConditionalComment = function(c){
	if(c === "["){
		this._state = IN_OPEN_CONDITIONAL_COMMENT;
	} else {
...
Tokenizer.prototype._stateInOpenConditionalComment = function(c){
	if(c === ">"){
		this._cbs.onopenconditionalcomment(this._buffer.substring(this._sectionStart, this._index));
		this._state = TEXT;
		this._sectionStart = this._index + 1;
	}
};
