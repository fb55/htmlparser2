...
Tokenizer.prototype._stateBeforeSpecialEnd = function(c) {
    this._state =
        this._special === SPECIAL_SCRIPT && (c === "c" || c === "C")
            ? AFTER_SCRIPT_1
            : this._special === SPECIAL_STYLE && (c === "t" || c === "T")
                ? AFTER_STYLE_1
                : TEXT;
};
...
Tokenizer.prototype._stateBeforeScript5 = function(c) {
    this._state =
        c === "/" || c === ">" || whitespace(c) ? SPECIAL_SCRIPT : IN_TAG_NAME;
    this._index--; //consume the token again
};
...
Tokenizer.prototype._stateBeforeStyle4 = function(c) {
    this._state =
        c === "/" || c === ">" || whitespace(c) ? SPECIAL_STYLE : IN_TAG_NAME;
    this._index--; //consume the token again
};
