...
Parser.prototype.write = function(chunk) {
    if (typeof chunk === "string") chunk = new Buffer(chunk);
        ...
        throw new Error("chunks must be buffers or string!");
...
Parser.prototype.end = function(chunk) {
    ...
    if (
        ...
        this._state === IN_CDATA ||
        this._state === CDATA_END_1 ||
        this._state === CDATA_END_2
    ) {
        this._emitIfToken("cdata");
    } else if (
        this._state === IN_COMMENT ||
        this._state === COMMENT_END_1 ||
        this._state === COMMENT_END_2
    ) {
...
Parser.prototype._emitToken = function(name) {
    this._cbs["on" + name](
        this._buffer.toString("utf8", this._sectionStart, this._index)
    );
    this._sectionStart = -1;
};
