...
var decodeCodePoint = require("entities/lib/decode_codepoint.js"),
	...
	DT_BETWEEN_PUB_SYM        = "DT_BETWEEN_PUB_SYM",
...
_$[DT_PUBLIC_DQ] = doctypeQuotedState("\"", "ondoctypepublic", DT_BETWEEN_PUB_SYM);
_$[DT_PUBLIC_SQ] = doctypeQuotedState("'",  "ondoctypepublic", DT_BETWEEN_PUB_SYM);

// Ignored 8.2.4.60 After DOCTYPE public identifier state
// 8.2.4.61 Between DOCTYPE public and system identifiers state

_$[DT_BETWEEN_PUB_SYM] = function(c){
	if(whitespace(c));
	else if(c === ">"){
		this._sectionStart = this._index + 1;
		this._state = DATA;
...
_$[DT_SYSTEM_DQ] = doctypeQuotedState("\"", "ondoctypeprivate", BOGUS_DOCTYPE);
_$[DT_SYSTEM_SQ] = doctypeQuotedState("'",  "ondoctypeprivate", BOGUS_DOCTYPE);

// Ignored 8.2.4.66 After DOCTYPE system identifier state
