...
module.exports = {
    ...
    get DomHandler() {
        defineProp(this, "DomHandler", {
            value: require("domhandler").Handler
        });
    ...
    get ElementType() {
        defineProp(this, "ElementType", {
            value: require("domhandler").ElementType
        });
    ...
    get WritableStream() {
        defineProp(this, "WritableStream", {
            value: require("./WritableStream.js")
        });
        return this.WritableStream;
    },
    get ProxyHandler() {
        defineProp(this, "ProxyHandler", {
            value: require("./ProxyHandler.js")
        });
